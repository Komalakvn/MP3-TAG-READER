...
int main(int argc, char* argv[])
{
	...
	printf("To get get help pass like : ./a.out --help\n");
    }
    else
    {
	...
	if (ret == p_view)				//If the return value from the function is to perform Viewing the MP3 Tag, 
	                                                    // proceed for Validation and Viewing process.
	{
	    printf ("--------------------------\n");
	...
	else if (ret == p_edit)		                                               	//If the return value from the function is to perform Editing the MP3 Tag, 
	                                                                                  //proceed for Validation and Editing process.
	{
	    printf ("MP3 Tag Reader and Editor:\n");
	    printf ("--------------------------\n");
	...
	else if (ret == p_help)	                                             //If the return value from the function is to show the Help Menu, display all the details 
	                                                                                             //-regarding the usage of MP3 Tag Reader & Editor.
	{
	...
	else if (ret == p_unsupported)	                                                      //If the return value from the function is other than 
	                                                                                           //to perform View/Edit/Help, print an error message.
	{
